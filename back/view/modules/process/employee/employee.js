class CRUDEmployee {
  ...
  print() {
    ...
    this.list.forEach(function (employee) {
      ...
      row += '<td class="align-middle text-center"><button idemployee="' + employee.idemployee + '" type="button" class="btn btn-outline-primary timetableEmployee"><i class="far fa-calendar-alt"></i></button></td>';
