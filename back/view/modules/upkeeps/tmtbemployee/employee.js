  ...
  eventsList() {
    ...
    document.querySelectorAll('.deleteTimetableEmployee').forEach(btnUpdate => {
      btnUpdate.onclick = function () {
        ...
        clase.delete();
        new ModalAction(clase.modalCargandoObject, 'Seguro que desea Eliminar los Horarios de ' + clase.employee.names + ' ' + clase.employee.paternal + ' ' + clase.employee.maternal);
      }
    });
